      ...
      >
         <div className="max-w-6xl mx-auto">
            ...
            <div className="founders-grid grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12 lg:gap-16">
               <FounderCard
                  name="Parth Dharia"
                  quote="A clean space is not just about how it looks. It changes how you feel every time you walk in"
                  description="Parth leads operations and strategy at AP cleanco. He is very particular about process and every job follows a structured approach so nothing gets missed and nothing gets wasted. If the outcome is not right, the job is not done."
               ...
               <FounderCard
                  ...
                  quote="We're not just removing junk. We're removing the weight that comes with it."
                  description="Arvind drives the customer experience and community side of the business. He believes the relationship matters as much as the result and the people whose homes we work in should feel respected throughout the entire process, not just at the end."
