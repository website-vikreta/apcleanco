...
export const metadata: Metadata = {
  title: 'Garage Cleaning Services NJ | AP cleanco',
  description: 'Professional garage cleanouts & deep cleaning in New Jersey. Same-day service, eco-friendly disposal, affordable pricing. Get a free quote today.',
  keywords: [
  ...
  openGraph: {
    title: 'Garage Cleaning Services NJ | AP cleanco',
    description: 'Professional garage cleanouts & deep cleaning in New Jersey. Same-day service, eco-friendly disposal.',
    images: [
      {
        url: '/hero-image.png',
        width: 1200,
        height: 630,
        alt: 'Professional Garage Cleaning Services NJ',
      },
    ],
  },
}
